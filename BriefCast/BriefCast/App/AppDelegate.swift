...
class AppDelegate: NSObject, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(
        ...
        // Fetch radio stream config from backend
        RadioConfig.shared.fetch()
        ...
        // Configure PaywallKit StoreManager (replaces RevenueCat)
        StoreManager.shared.configure(productIds: SubscriptionManager.allProductIds)
